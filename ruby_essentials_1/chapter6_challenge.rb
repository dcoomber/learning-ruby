...
# Word beginning with a single consonent, the consonent moves to the end followed by 'ay'
# Word beginning with a single vowel, the word stays the same just add 'ay'
# Word beginning with multiple consonants, the first consonant moves to the end followed by 'ay'

# Bonus challenge
# Write a program that translates a phrase into pig latin
